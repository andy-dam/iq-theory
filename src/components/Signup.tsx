  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center">
        ...
        >
          <h1 className="justify-center items-center mx-auto text-3xl pb-3 w-56">Signup</h1>
          ...
          <div className="max-w-64">
            <button className=" text-white w-52  bg-gray-800 rounded-md p-2 m-2 max-w-52 hover:opacity-50" type="submit" disabled={loading}>
              Sign Up
            </button>
            <h2 className="">
            ...
            <Link to="/login" className="">
              <button className=" border-2 border-gray-400 rounded-md p-2 m-2 max-w-52 hover:opacity-50" disabled={loading}>
                Go to Log In
              </button>
            </Link>
          </div>
